package com.bank.islamic.mudarabahterminvestmentaccount.model;
...
/**
 * The BIAN control record for this service domain: "Mudarabah Investment Account Fulfillment Arrangement".
 *
 ...
 * to its asset type (Mudarabah Investment Account). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Mudarabah Investment Account Fulfillment Arrangement";
