...
class ApplicationTests {
    ...
    void serviceDomainMetadataIsServed() {
        ...
        assertThat(meta).containsEntry("serviceDomain", "Mudarabah Term Investment Account");
    ...
    void controlRecordLifecycleWorks() {
        var created = rest.postForEntity(
                "http://localhost:" + port + "/v1/mudarabah-investment-account-fulfillment-arrangement/initiate",
